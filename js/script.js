...
const continue_btn_1 = info_box.querySelector(".buttons .restart_1");
const continue_btn_2 = info_box.querySelector(".buttons .restart_2");
const continue_btn_3 = info_box.querySelector(".buttons .restart_3");
